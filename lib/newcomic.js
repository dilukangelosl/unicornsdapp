const contract = {
  contractAddress: "0x1b51E5eD7b034282858B86318BED08DD84Ed79e4",
  abi: [
    {
    ...
    {
      inputs: [],
      name: "maxMintAmountPerTransaction",
    ...
    },
    {
      ...
      name: "setErc20FundAddress",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    {
      inputs: [{ internalType: "address", name: "_bAddress", type: "address" }],

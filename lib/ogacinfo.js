const contractAddress = "0xA83ad73eEd496fcD7adc5F4027CbAD818D0075a0";
const abi = [
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: "uint256", name: "_new_price", type: "uint256" }],
    name: "changeFlorPrice",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint8", name: "mintType", type: "uint8" },
    ],
  ...
  },
  {
    inputs: [],
    name: "ogToken",
    outputs: [{ internalType: "contract IOGToken", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "string", name: "_baseURILink", type: "string" }],
    name: "setBaseURI",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    ...
    name: "setBreedingContractAddress",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
